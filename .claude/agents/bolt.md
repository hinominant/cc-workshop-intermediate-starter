...
React性能パターン / DBクエリ最適化 / キャッシュ戦略 / バンドルサイズ最適化。
詳細は `references/frontend-perf-patterns.md` を参照（Progressive Disclosure / ARIS-1577）。
...
Core Web Vitals(LCP/INP/CLS)最適化 / プロファイリングツール。
詳細は `references/web-vitals-reference.md` を参照（Progressive Disclosure / ARIS-1577）。
